function Isosurfaces( volume, isovalue, mat_color, cmap, sw_shader,  sw_ref, ka_value, kd_value, ks_value, n_value)
{
    ...
    mat_color = Math.round(KVS.Clamp( mat_color, smin, smax ));
    ...
    if(sw_shader == 0){               //gouraud shaderを選択
		...
		ka_value: {value: ka_value/100},
		kd_value: {value: kd_value/100},
		ks_value: {value: ks_value/100},
		n_value: {value: n_value},
		reflection_id: {value: sw_ref}
	    }	
        });
